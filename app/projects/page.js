...
const page = () => {
    return (
        <div>
            ...
            <title>Projects - TeacherTest</title>
                ...
                <div className="container py-5">
                    ...
                    <div className="row row-cols-1 row-cols-md-2 mx-auto" style={{ maxWidth: 900 }}>
                        <div className="col mb-4">
                            <div><a href="#"><img className="rounded img-fluid shadow w-100 fit-cover" src="/1.jpg" style={{ height: 250 }} /></a>
                                <div className="py-4"><span className="badge bg-primary mb-2">Website</span>
                        ...
                        <div className="col mb-4">
                            <div><a href="#"><img className="rounded img-fluid shadow w-100 fit-cover" src="/2.jpg" style={{ height: 250 }} /></a>
                                <div className="py-4"><span className="badge bg-primary mb-2">Website</span>
                                    <h4 className="fw-bold">Lorem libero donec</h4>
                                    <p className="text-muted">Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p>
                                </div>
                        ...
                        <div className="col mb-4">
                            <div><a href="#"><img className="rounded img-fluid shadow w-100 fit-cover" src="/3.jpg" style={{ height: 250 }} /></a>
                                <div className="py-4"><span className="badge bg-primary mb-2">Website</span>
                                    <h4 className="fw-bold">Lorem libero donec</h4>
                                    <p className="text-muted">Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p>
                                </div>
