        ...
        <div className="container py-5">
          <div className="row mb-4 mb-lg-5">
            <div className="col-md-8 col-xl-6 text-center mx-auto">
              ...
              <h2 className="fw-bold">All Star Talent</h2>
              <p className="text-muted">No matter the project, our team can handle it.&nbsp;</p>
            </div>
          </div>
          <div className="row row-cols-2 row-cols-md-3 mx-auto" style={{ maxWidth: 700 }}>
            <div className="col mb-4">
              <div className="text-center"><img className="rounded mb-3 fit-cover" width={150} height={150} src="/avatar4.jpg" />
                <h5 className="fw-bold mb-0"><strong>John Smith</strong></h5>
                <p className="text-muted mb-2">Erat netus</p>
              </div>
            </div>
            <div className="col mb-4">
              <div className="text-center"><img className="rounded mb-3 fit-cover" width={150} height={150} src="/avatar6.jpg" />
                <h5 className="fw-bold mb-0"><strong>John Smith</strong></h5>
                <p className="text-muted mb-2">Erat netus</p>
              </div>
            </div>
            <div className="col mb-4">
              <div className="text-center"><img className="rounded mb-3 fit-cover" width={150} height={150} src="/avatar5.jpg" />
                <h5 className="fw-bold mb-0"><strong>John Smith</strong></h5>
                <p className="text-muted mb-2">Erat netus</p>
              </div>
            </div>
            <div className="col mb-4">
              <div className="text-center"><img className="rounded mb-3 fit-cover" width={150} height={150} src="/avatar3.jpg" />
                <h5 className="fw-bold mb-0"><strong>John Smith</strong></h5>
                <p className="text-muted mb-2">Erat netus</p>
              </div>
            </div>
            <div className="col mb-4">
              <div className="text-center"><img className="rounded mb-3 fit-cover" width={150} height={150} src="/avatar1.jpg" />
                <h5 className="fw-bold mb-0"><strong>John Smith</strong></h5>
                <p className="text-muted mb-2">Erat netus</p>
              </div>
            </div>
            <div className="col mb-4">
              <div className="text-center"><img className="rounded mb-3 fit-cover" width={150} height={150} src="/avatar2.jpg" />
                <h5 className="fw-bold mb-0"><strong>John Smith</strong></h5>
                <p className="text-muted mb-2">Erat netus</p>
              </div>
            </div>
